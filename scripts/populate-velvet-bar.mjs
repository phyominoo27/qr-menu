...
// Header row
const headerRow = ['category', 'name', 'description', 'price', 'image'];

// Velvet Bar items (24 items)
...
const allRows = [headerRow, ...velvetBarItems];
...
try {
  ...
  console.log('✅ Velvet Bar sheet populated with 24 items + header');
} catch (err) {
